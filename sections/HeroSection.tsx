...
export default function HeroSection(){
    ...
    return (
        ...
        >
            ...
            <div>
                <Image
                    className="absolute top-[310px] left-0 sm:left-[20vw] w-[400px] md:top-[50vh] md:left-[50vw] md:w-[340px] lg:top-[40vh] lg:left-[48vw] lg:w-[480px] xl:static xl:w-[600px] 2xl:w-[650px] h-auto"
