...
export default function PrivacyPolicySection(){
    ...
    return (
        <div className={`flex flex-col items-center bg-tertiary-orange h-full font-semibold space-y-11 pt-8 pb-20 ${dmSansFont.className}`}>
            <div className={`${manropeFont.className} text-[65px] font-normal text-center w-[730px]`}>Privacy Policy</div>
            <div className={`w-[730px] flex flex-col space-y-12`}>
                <div className={`w-[730px] flex flex-col space-y-4`}>
